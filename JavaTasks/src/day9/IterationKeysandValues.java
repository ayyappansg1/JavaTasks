...
public class IterationKeysandValues {
	...
	public static void main(String[] args) {
		...
		for(Entry<Integer,String> newly:iterlinked) {
			...
			System.out.println(newly.getValue());
		}
		...
		for(Entry<Character,String> iterr:itertree) {
			System.out.println(iterr.getKey());
			System.out.println(iterr.getValue());
		}
		...
		for(Entry<String,String> iterss:itermap) {
			System.out.println(iterss.getKey());
			System.out.println(iterss.getValue());
		}
